...
public class RadiusAccountingInterimUpdate {
	final static String RADIUS_PORT = System.getProperty("RADIUS_PORT", "1813");
	...
	public static void main(String[] args) throws Exception {
		...
		RadiusPacket resp = start(channel, USERNAME);
		System.out.println(resp.toString());
		
		channel.close();
	}

	static RadiusPacket start(DatagramChannel channel, String username) throws Exception {
		...
		req.add(new AcctStatusType(AcctStatusType.Type.InterimUpdate));
